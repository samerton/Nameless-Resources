                        ...
                        <div class="card-body">
                            ...
                            <form role="form" action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="title" id="catname"
                                        value="{$CATEGORY_NAME_VALUE}" placeholder="{$CATEGORY_NAME}"
                                        autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <label for="catdesc">{$CATEGORY_DESCRIPTION}</label>
                                    <textarea id="catdesc" name="description" placeholder="{$CATEGORY_DESCRIPTION}"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="hidden" name="perm-view-0" value="0" /><input
                                                    ...
                                                    value="1" type="checkbox" {if $GUEST_PERMISSIONS|count &&
                                        ...
                                        {foreach from=$GROUP_PERMISSIONS item=group}
                                            ...
                                            <td><input type="hidden" name="perm-post-{$group->id}" value="0" /><input
                                                    ...
                                                    $group->can_post eq 1} checked{/if} /></td>
                                            <td><input type="hidden" name="perm-premium-{$group->id}" value="0" /><input
                                                    onclick="colourUpdate(this);" name="perm-premium-{$group->id}"
                                    ...
                                    <tbody>
                                        {foreach from=$GROUP_PERMISSIONS item=group}
                                            ...
                                            <td><input type="hidden" name="perm-edit_resource-{$group->id}"
                                                    value="0" /><input onclick="colourUpdate(this);"
                                                    name="perm-edit_resource-{$group->id}"
                                                    id="Input-edit_resource-{$group->id}" value="1" type="checkbox" {if
                                                    $group->can_edit eq 1} checked{/if} /></td>
                                            <td><input type="hidden" name="perm-delete_resource-{$group->id}"
                                                    value="0" /><input onclick="colourUpdate(this);"
                                                    name="perm-delete_resource-{$group->id}"
                                                    id="Input-delete_resource-{$group->id}" value="1" type="checkbox"
                                                    {if $group->can_delete eq 1} checked{/if} /></td>
                                            <td><input type="hidden" name="perm-edit_review-{$group->id}"
                                                    value="0" /><input onclick="colourUpdate(this);"
                                                    name="perm-edit_review-{$group->id}"
                                                    id="Input-edit_review-{$group->id}" value="1" type="checkbox" {if
                                                    $group->can_edit_review eq 1} checked{/if} /></td>
                                            <td><input type="hidden" name="perm-delete_review-{$group->id}"
                                                    value="0" /><input onclick="colourUpdate(this);"
                                                    name="perm-delete_review-{$group->id}"
                                                    id="Input-delete_review-{$group->id}" value="1" type="checkbox" {if
                                                    $group->can_delete_review eq 1} checked{/if} /></td>
                                        </tr>
                                        {/foreach}
                                    </tbody>
                                </table>
