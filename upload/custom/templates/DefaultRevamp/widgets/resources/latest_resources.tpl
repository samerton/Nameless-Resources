          ...
          <div class="ui relaxed list">
            ...
            <div class="item">
              ...
              <div class="content">
                ...
                <a href="{$resource.creator_profile}" style="{$resource.creator_style}" data-poload="{$USER_INFO_URL}{$resource.creator_id}">{$resource.creator_username}</a> · <span data-toggle="tooltip" data-content="{$resource.released_full}">{$resource.released}</span>
