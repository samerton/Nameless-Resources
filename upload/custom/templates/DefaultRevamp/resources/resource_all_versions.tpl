					...
					<table class="ui fixed single line selectable unstackable small padded res table" id="sticky-threads">
						...
						<tbody>
							{foreach from=$RELEASES item=release}
                          	<tr>
								<td>{$release.tag}</td>
								<td><span data-toggle="tooltip" data-content="{$release.date_full}">{$release.date}</span></td>
			                	...
			                	<td>
                  					<span class="res right floated">
                                    	<a href="{$release.download_url}" class="ui blue button mini" target="_blank">{$DOWNLOAD}</a>
                                	</span>
                				</td>
			  				</tr>
			  				{/foreach}
