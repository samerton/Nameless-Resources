    ...
    <div class="ui centered row">
        ...
        <div class="ui ten wide tablet twelve wide computer column">
            <div class="ui segment">
                ...
                <div class="ui button right floated" data-toggle="modal" data-target="#add-license-modal"
                        ...
                        <tr>
                            <td>
                                <a href="{$license.profile}" style="{$license.style}"><img src="{$license.avatar}"
                                        class="ui avatar image" style="max-height:25px;max-width:25px;"
                            ...
                            <td>
                                <span
                                    class="ui label {if $license.status eq '0'}yellow{elseif $license.status eq '1'}green{else}red{/if}">{$license.status_text}</span>
                            </td>
                            <td>
