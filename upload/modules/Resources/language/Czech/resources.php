 ...
 *  License: MIT
 *
 *  Czech Language for Resources module
 */
...
$language = array(
    ...
    */ 
    ...
    'link_to_github_repo' => 'Odkaz na GitHub repozitář',
    'required' => 'Vyžadováno',
    'resource_name' => 'Název',
    'resource_icon' => 'Ikona souboru',
    'resource_upload_icon' => 'Nahrát ikonu',
    'resource_change_icon' => 'Změnit ikonu',
    'resource_short_description' => 'Krátký popis',
    ...
    'short_description_required' => 'Zadejte krátký popis',
    ...
    'short_description_min_2' => 'Krátký popis musí obsahovat alespoň 2 znaky',
    ...
    'short_description_max_64' => 'Krátký popis může obsahovat maximálně 64 znaků',
    ...
    'viewing_all_releases' => 'Prohlížení vydání souboru {x}', // Don't replace {x}
    'viewing_release' => 'Prohlížení vydání {x} souboru {y}', // Don't replace {x} or {y}
    'viewing_all_versions' => 'Prohlížení verzí souboru {x}', // Don't replace {x}
    'viewing_all_reviews' => 'Prohlížení recenzí souboru {x}', // Don't replace {x}
    ...
    'type' => 'Typ',
    'free_resource' => 'Zdarma',
    'premium_resource' => 'Placené',
    'price' => 'Cena',
    ...
    'overview' => 'Přehled',
    'releases_x' => 'Vydání ({x})', // Don't replace {x}
    'versions_x' => 'Verze ({x})', // Don't replace {x}
    'reviews_x' => 'Recenze ({x})', // Don't replace {x}

    // Widgets
    'latest_resources' => 'Poslední soubory',
    'top_resources' => 'Nejlepší soubory',
    'no_latest_resources' => 'Žádné soubory',
    'no_top_resources' => 'Žádné soubory',
    ...
    'new_category' => '<i class="fa fa-plus-circle"></i> Nová kategorie',
    'creating_category' => 'Vytváření kategorie',
    'category_name' => 'Název kategorie',
    'category_description' => 'Popis kategorie',
    'input_category_title' => 'Zadejte název kategorie.',
    'category_name_minimum' => 'Název kategorie musí obsahovat minimálně 2 znaky.',
    'category_name_maxmimum' => 'Název kategorie může obsahovat maximálně 150 znaků.',
    'category_description_maximum' => 'Popis kategorie může obsahovat maximálně 250 znaků.',
    ...
    'currency' => 'ISO-4217 měna',
    'invalid_currency' => 'Neplatná ISO-4217 měna! Seznam platných kódů lze nalézt <a href="https://en.wikipedia.org/wiki/ISO_4217#Active_codes" target="_blank" rel="noopener nofollow">zde</a>',
    'upload_directory_not_writable' => 'Adresář uploads/resources není zapisovatelný!',
    'maximum_filesize' => 'Maximální velikost souborů (v kilobytech)',
    'invalid_filesize' => 'Neplatná velikost souboru!',
    'pre_purchase_information' => 'Informace před platbou',
    'invalid_pre_purchase_info' => 'Neplatná předplatební informace! Ujistěte se, že má méně než 100 000 znaků.',
    'paypal_api_details' => 'Podrobnosti PayPal API',
    'paypal_api_details_info' => 'Hodnoty těchto polí jsou skryty z bezpečnostních důvodů.<br />Při aktualizaci těchto nastavení zadejte obě hodnoty.',
